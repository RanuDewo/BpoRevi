                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-success  mt-3 mb-3" data-bs-toggle="modal"
                                data-bs-target="#basicModal2"><i class="ri-add-box-fill"></i> Import dari Excel</button>
        ...
        <div class="modal fade" id="basicModal2" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ url('upload_data_spg/excel') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
